...
And once Santa gets the list of all the good children, he invokes the other _Pokemon_ microservice to get a toy for each children.
As seen below, the

[[javaadvent-listing-toy-invoc]]
