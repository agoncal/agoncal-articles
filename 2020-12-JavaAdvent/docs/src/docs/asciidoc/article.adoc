...
Christmas is coming!
Like every year, Santa news to schedule its presents delivery.
Can you imagine?
Millions of children will receive a present on the night of the 24th of December.
To achieve this prowess, Santa needs a bit of technical help to schedule the delivery.

== Microservices

Santa has its own microservice, with its own database, to schedule the delivery.
There, he can find his past deliveries per country (per timezone), but more important, he can create the new schedule for 2020.
For that, Santa accesses two external microservices developed and maintained by external partners:

* _Kids_: third-party microservice that gives you the list of kids per country who deserve a present (the naughty ones don't get anything this year)
* _Pokemon_: external microservice returning Pokemons (this year Santa will deliver Pokemons, and that's all)
...
On the 24th of December, Santa will only have a few hours to deliver Pokemons to all the nice children all over the globe.
...
As a backup, if Santa cannot access the _Kids_ microservice, he can base his schedule from the schedule of the previous year he has stored in its database.
And if the _Pokemon_ microservice does not respond, well, Santa will deliver some lolies instead (he has tons of lolies).

[[javaadvent-figure-resilient]]
.Microservices
image::javaadvent-figure-architecture.png[]
