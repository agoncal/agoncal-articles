...

{
  ...
  "tenantId": "1234-abcd",
  "user": {
    "name": "antonio.goncalves@gmail.com",
    "type": "user"
  }
}
----
...
Username: antonio.goncalves@gmail.com

Java SE Web Apps in subscription Paiement à l’utilisation:
* 1: <create>
...
=== Redeploying a New Version of the App
